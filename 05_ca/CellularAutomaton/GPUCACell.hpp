...
namespace GPU
{
    class CACell
    {
        public:
            ...
            __host__ __device__
            void init(const GPU::LayerDoublets* doublets, const GPU::LayerHits* hitsOnLayer,
    ...
    //        }
            ...
            __host__ __device__
            bool check_alignment_and_tag(const CACell * cells, unsigned int innerCellId,
            ...
            __host__ __device__
            bool haveSimilarCurvature(const CACell * cells, unsigned int innerCellId,
                    const float ptmin, const float region_origin_x, const float region_origin_y,
    ...
    //                 }
        ...
        private:
            ...
            const GPU::LayerDoublets* theDoublets;
            float theInnerX;
            float theOuterX;
            float theInnerY;
            float theOuterY;
