...
__global__
void debug_input_data(const GPU::Event* event, const GPU::LayerDoublets* gpuDoublets,
        const GPU::LayerHits* gpuHitsOnLayers, const GPU::Region* region, unsigned int maxNumberOfHits)
{
